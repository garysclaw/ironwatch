...
//   CpuMetrics: { overall_usage: number, core_usages: number[], frequency_mhz: number | null }
//
...
function makeCpuMetrics(overrides: Partial<CpuMetrics> = {}): CpuMetrics {
  return {
    overall_usage: 47.3,
    core_usages: [30.0, 50.0, 60.0, 70.0],
    frequency_mhz: 2400,
    ...overrides,
  }
}
...
describe('CpuPanel', () => {
  ...
  it('renders correct number of core bars', () => {
    ...
    render(<CpuPanel cpu={makeCpuMetrics({ core_usages: coreUsages })} history={[]} />)
